...
import com.ademir.mooview.comments.CommentsActivity
...
class MovieListFragment : Fragment(), MovieAdapter.OnMovieClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler_view.prepare(MovieAdapter(this@MovieListFragment), LinearLayoutManager(context))
        loadContent()
    }
    ...
    override fun onMovieClick(view: View, position: Int) {
        context?.let {
            startActivity(MovieDetailsActivity.createIntent(it, adapter.getMovieId(position)))
        }
    }
    ...
    companion object {
        ...
        fun newInstance(type: Int = MovieListFragment.DEFAULT): MovieListFragment {
